// Package binlookup provides a Go client for the BIN Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/binlookup?utm_source=go&utm_medium=readme
package binlookup
...
// Request contains the parameters for the BIN Lookup API.
//
// Parameters:
//   - bin (required): string - The first six digits of the credit card number (BIN) [minLength: 6, maxLength: 8]
type Request struct {
	Bin string `json:"bin"` // Required
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"bin": {Type: "string", Required: true, MinLength: intPtr(6), MaxLength: intPtr(8)},
	}
...
// ResponseData contains the data returned by the BIN Lookup API.
