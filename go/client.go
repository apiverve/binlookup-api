...
const (
	baseURL        = "https://api.apiverve.com/v1/binlookup"
	defaultTimeout = 30 * time.Second
)

// Client is the BIN Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new BIN Lookup API client.
...
// Execute makes a request to the BIN Lookup API with typed parameters.
//
