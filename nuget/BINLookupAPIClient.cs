...
namespace APIVerve.API.BINLookup
{
...
#endif
    {
        ...
        {
            { "bin", new ValidationRule { Type = "string", Required = true, MinLength = 6, MaxLength = 8 } }
        };
        ...
        public BINLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BINLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BINLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(BINLookupQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BINLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BINLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BINLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BINLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BINLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
