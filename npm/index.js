...
class binlookupWrapper {
    ...
    constructor(options) {
        ...
        this.validationRules = {"bin":{"type":"string","required":true,"minLength":6,"maxLength":8}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/binlookup`);
        }
    }
