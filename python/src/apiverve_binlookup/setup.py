...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/binlookup',
        'Source': 'https://github.com/apiverve/binlookup-api',
        'Bug Tracker': 'https://github.com/apiverve/binlookup-api/issues'
    },
    classifiers=[
