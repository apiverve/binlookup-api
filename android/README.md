...
```gradle
dependencies {
    implementation 'com.github.apiverve:binlookup-api:1.1.12'
}
```
...
BINLookupAPIClient client = new BINLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/binlookup](https://docs.apiverve.com/ref/binlookup)
...
- **Issues:** [GitHub Issues](https://github.com/apiverve/binlookup-api/issues)
